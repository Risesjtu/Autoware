...
{
private:
  bool draw_ignore_line_;
  int left_ignore_line_;
  int right_ignore_line_;
  int bottom_emergency_line_;
  ...
  cv::Mat DrawIgnoreLine(cv::Mat in_image, int left_horizon_line, int right_horizon_line, int bottom_vertical_line);
