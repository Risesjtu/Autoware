...
protected: //Planning Related variables
  ...
  std::vector<std::vector<PlannerHNS::WayPoint> > m_pre_GlobalPaths;
  ...
  ros::Publisher pub_ScenarioEnded;
  ...
  ros::Subscriber sub_fitness_score;
  ...
  void callbackFitnessScore(const autoware_msgs::NDTStat &msg);
