...
#include "roadedge_analyse_core.h"
...
public:
  ...
  bool bEnableReedsShepp;
  bool bEnableRoadEdgePlanning;
  ...
  WayPlannerParams()
  {
    ...
    bEnableReedsShepp = false;
    bEnableRoadEdgePlanning=false;
  }
};
...
private:
  ...
  autoware_msgs::DrivingStatus end_point_status_;
  ...
  protected:
    ...
    int LoadSimulationData(const std::string &goalDataFilePath);
