    ...
    pose_match_threshold_(25.0)
{
  ...
  private_nh_.param<double>("pose_match_threshold", pose_match_threshold_, 25.0);
...
void VelocitySetInfo::locationCallback(const autoware_msgs::NDTStat &msg){
  fitness_score_ = msg.score;
}
