...
public:
  ...
  std::string ground_cloud;
  std::string no_ground_cloud;
  ...
  ParamServer() {
    ...
    nh_.param<std::string>("lidar_curb_detection/ground_cloudTopic",
                            ground_cloud, "points_raw");
    nh_.param<std::string>("lidar_curb_detection/no_ground_cloud",
                             no_ground_cloud, "points_raw");
    // cloudMapperMsg
